...
class ScanView extends WatchUi.View {
    ...
    public function onUpdate(dc as Dc) as Void 
    {
        ...
        dc.clear();
        dc.drawText(dc.getWidth() / 2, 40, Graphics.FONT_SMALL, "SEARCHING...", Graphics.TEXT_JUSTIFY_CENTER);
       
        var displayResult = _scanDataModel.getDisplayResult();

        var str = "Nitrox: " + _scanDataModel.getDisplayIndex() + "/" + _scanDataModel.getResultCount();
